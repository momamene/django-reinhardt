...
django-django-reinhardt could always use more documentation, whether as part of the
official django-django-reinhardt docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.3, 3.4 and 3.5. Check
   https://travis-ci.org/momamene/django-reinhardt/pull_requests
